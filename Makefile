...
bin/test: bin/window.o bin/message.o bin/unix.o bin/test.o
	$(CXX) $(LDFLAGS) bin/window.o bin/message.o bin/unix.o bin/test.o -o $@

bin/window.o: src/core/window.cc src/core/window.h src/core/message.h src/platform/unix.h
	$(CXX) $(CXXFLAGS) $< -o $@ -c
