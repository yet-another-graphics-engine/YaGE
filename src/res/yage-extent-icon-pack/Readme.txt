To Use this extent icon pack,you should enable libpixbufloader-svg.dll first.
...
And then copy the "YaGE" directory to %GTKDIR%\share\icons.

Reference:http://www.gtk.org/download/win32_tutorial.php